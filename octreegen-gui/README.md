...
First install the required libraries :
	...
	wget --content-disposition https://gitlab.com/Dexter9313/octree-file-format/-/jobs/artifacts/1.1.0/raw/octreegen-1.1.0-linux_amd64.deb?job=pack:octreegen
	wget --content-disposition https://gitlab.com/Dexter9313/octree-file-format/-/jobs/artifacts/1.1.0/raw/liboctree-1.1.0-linux_amd64.deb?job=pack:liboctree
	sudo dpkg -i ./*.deb

Then simply install the following deb package :

Download (.deb) : [octreegen-gui 1.1.0](https://gitlab.com/Dexter9313/octree-file-format/-/jobs/artifacts/1.1.0/raw/octreegen-gui-1.1.0-linux_amd64.deb?job=pack:octreegen-gui)
